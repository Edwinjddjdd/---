...
| 要求 | 主要成果 |
|---|---|
| 学习旋翼空气动力学基础，重点掌握叶素理论及动态入流 | [二、旋翼空气动力学基础](02、旋翼空气动力学基础.md) |
| 梳理涡环状态经典研究、边界计算和入流修正 | [三、涡环状态研究综述](03、涡环状态研究综述.md) |
| 明确建模技术路线与参考数据 | [四、建模依据与技术路线](04、建模依据与技术路线.md)、[五、数据来源与验证依据](05、数据来源与验证依据.md) |
...
| 07、课程资料摘要 | 课程资料二次整理 | 保留课程到模型接口的对应关系 |
| 08、专题文献笔记 | VRS 与动态入流专题 | 保留单篇文献的判断依据 |
| 09、深度阅读笔记 | 教材深读 | 保留轴系、六自由度和流态分析细节 |
...
完整登记见 [六、参考文献与资料来源](06、参考文献与资料来源.md)。
